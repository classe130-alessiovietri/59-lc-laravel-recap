...
@section('page-title', 'Modifica '.$tag->name)
                ...
                <div class="card-body">
                    <form action="{{ route('admin.tags.update', ['tag' => $tag->id]) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" id="name" name="name" required minlength="3" maxlength="255" value="{{ old('name', $tag->name) }}" placeholder="Inserisci il nome...">
                        </div>
